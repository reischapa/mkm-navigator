/**
 * Created by chapa on 26-11-2016.
 */
...
public class M11DedicatedApp {
    ...
    public boolean request(String requestURL) {
        ...
        try {
            ...
            String oauth_nonce = "53eb1f449sdaasdsa09d6";//"" + System.currentTimeMillis() ;
            ...
            //String oauth_signature = Base64.encodeToString(digest,16) ;

            String oauth_signature = org.apache.commons.codec.binary.Base64.encodeBase64String(digest);
            ...
            HttpsURLConnection connection = ProgramInput.setupHTTPSURLConnection(requestURL, CACertificateStrings.MKMAPI);
    ...
    public static void main(String[] args) {
        ...
        String mkmAppToken = "MiBeU6kI1J8mxqrO" ;
        String mkmAppSecret = "r9su5j6Sqm3BhbEAygnq1vWwGJ6NW1Zp" ;
        String mkmAccessToken = "MafxXUc77mfbY9Y6IVJiB9b0IUdjmPu7" ;
        String mkmAccessTokenSecret = "fVCWL0gG0NSt6tiD306uDAfIGoP6Qb0Z" ;
        ...
        if (app.request("https://www.mkmapi.eu/ws/v2.0/output.json/account")) {
            System.out.println(app.responseContent());
        }

        // test with active console debug
        if (app.request("https://www.mkmapi.eu/ws/v2.0/output.json/products/265535")) {
            System.out.println(app.responseContent());
        }

//        if (app.request("https://www.mkmapi.eu/ws/v2.0/products/serra_angel/1/1/false")) {
