package com.mkmnav.backend.CardFramework;
...
public class Card implements Serializable {
    ...
    public Card(String mCardName, String mCardExpansion){
        this.mCardName = mCardName;
        this.mCardExpansion = mCardExpansion;
        //this.mCardID = new CardID(mCardName,mCardExpansion);
    }

    public Card(String mCardName, String mCardExpansion, String mCardPrice){
        this.mCardName = mCardName;
        this.mCardExpansion = mCardExpansion;
    ...
    public Card(String mCardName, String mCardExpansion, String mCardPrice, int mYOffset,int mXOffset){
